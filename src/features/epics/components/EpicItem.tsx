...
const EpicItem: React.FC<IProps> = ({ epicItem }) => {
  ...
  const desktopView = (
    <div className="hidden lg:flex flex-col gap-16px bg-white border-s-4 border-s-border-dark shadow-primary p-16px rounded-8px lg:justify-between">
      ...
      <div className="flex flex-col gap-12px">
        ...
        {epicItem?.assignee?.name && (
          <div className="flex gap-12px">
            {/* avatar */}
            <div className="rounded-lg bg-success-dark size-10 flex items-center justify-center">
      ...
      {/* epic footer */}
      <footer className="border-t border-t-surface-low flex justify-between items-end mt-auto">
        {/* created by */}
