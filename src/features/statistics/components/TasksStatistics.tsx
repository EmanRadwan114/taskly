...
const TasksStatistics: React.FC = () => {
  ...
  const { data: projectsData } = useFetchAllProjects();
  ...
  return (
    <>
      ...
      <form
        ...
        className="flex justify-between items-center gap-2 w-full px-4 py-3 bg-surface-low rounded-lg"
      >
                    ...
                    <div className="absolute top-full left-0 mt-2 z-50 bg-white border border-gray-200 rounded-lg p-3 shadow-xl backdrop-blur-xs">
                      <DayPicker
                        ...
                        onSelect={(value) => {
                          ...
                          onHandleTasksFilter(value);
                          if (value?.from && value?.to) setIsOpen(false);
                        }}
                        disabled={tasksIsLoading}
                        min={2}
                        max={6}
        ...
        <div>
          <div className="flex items-center gap-4">
            <FormField
              ...
              containerClassName={`bg-white! py-2! px-4! rounded-md min-w-40`}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <StatsCard
          ...
          title="Total Tasks"
          icon={<TasksIcon className="size-5 text-primary" />}
        ...
        <StatsCard
          ...
          icon={<Check className="size-5 text-success-text" />}
        ...
        <StatsCard
          ...
          title="overdue Tasks"
          icon={<WarningIcon className="w-5 text-error-dark" />}
